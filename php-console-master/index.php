...
$stmts     = $parser->parse("../data/log_pattern_src/DB.class.php");
$show_tree = new PHPParser_ShowSyntaxTree;
$stmts_arr = $show_tree->get_stmts2array($stmts);
...
<html>
    ...
    <body>
        <div class="output"><?php krumo::dump($stmts_arr);echo $debugOutput ?></div>
